...
const PlanForm: React.FC<PlanFormProps> = ({ onSubmit, isLoading }) => {
  ...
  return (
    <div id="planner" className="max-w-4xl mx-auto px-6 py-24 relative">
      <div className="absolute -top-24 left-1/2 -translate-x-1/2 w-64 h-64 bg-emerald-500/20 blur-[100px] rounded-full -z-10"></div>
        ...
        <form onSubmit={handleSubmit} className="space-y-8">
          <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
            <div className="space-y-3">
              ...
              <input 
                ...
                className="w-full px-6 py-4 rounded-2xl bg-slate-800/50 border border-slate-700 focus:border-emerald-500 focus:ring-1 focus:ring-emerald-500 outline-none transition-all text-white placeholder:text-slate-600"
              />
            </div>
            <div className="space-y-3">
          ...
          <div className="space-y-3">
            ...
            <textarea 
              ...
              className="w-full px-6 py-4 rounded-2xl bg-slate-800/50 border border-slate-700 focus:border-emerald-500 focus:ring-1 focus:ring-emerald-500 outline-none transition-all text-white placeholder:text-slate-600 resize-none"
            ></textarea>
          </div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
            <div className="space-y-3">
              ...
              <select 
                ...
                onChange={handleChange}
                className="w-full px-6 py-4 rounded-2xl bg-slate-800/50 border border-slate-700 focus:border-emerald-500 focus:ring-1 focus:ring-emerald-500 outline-none transition-all text-white appearance-none cursor-pointer"
              >
